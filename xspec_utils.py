...
if sys.version_info.major <= 2:
    ...
    from xspec import AllData, Model, Fit, Plot
...
def get_specparams(obsID, model, phaname, rmffile, arffile,
    ...
    if not skip_calc:
        ...
        if verbose:
            print(f'Setting RMF to {pha.response}')
